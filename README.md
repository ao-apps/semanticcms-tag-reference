...
[![Build](https://github.com/ao-apps/semanticcms-tag-reference/actions/workflows/build.yml/badge.svg?branch=1.x)](https://github.com/ao-apps/semanticcms-tag-reference/actions?query=workflow%3ABuild)
